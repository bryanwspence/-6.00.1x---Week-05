...
WORDLIST_FILENAME = 'words.txt'
    ...
    class Message(object):
        ...
        def build_shift_dict(self, shift):
            ...
            self.shiftDict = {k:v for k,v in zip(allLettersOrig,allLettersShift)}
        ...
        def apply_shift(self, shift):
            ...
            for i in self.message_text:
                if i not in self.build_shift_dict(shift).keys():
                    shiftedText.append(i)
                    continue
                else:
                    shiftedText.append(self.build_shift_dict(shift)[i])
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(26):
            ...
            validWords = sum([is_word(self.get_valid_words(), w) for w in words])
